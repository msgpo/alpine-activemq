...
MOUNTFLAGS := # -v $(CURDIR)/conf:/opt/activemq/conf -v $(CURDIR)/data:/opt/activemq/data
...
PORTFLAGS  := -p 1883:1883 -p 5672:5672 -p 8161:8161 -p 61613:61613 -p 61614:61614 -p 61616:61616
PROXYFLAGS := --build-arg http_proxy=$(http_proxy) --build-arg https_proxy=$(https_proxy) --build-arg no_proxy=$(no_proxy)

RUNFLAGS   := -e PGID=$(PGID) -e PUID=$(PUID) -c 512 -m 512m
